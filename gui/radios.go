...
var radios = []list.Item{
	...
	item{
		...
		metadataUrl: "https://www.radiofrance.fr/fip/api/live/webradios/fip_jazz",
	},
	item{
		...
		metadataUrl: "https://www.radiofrance.fr/francemusique/api/live/webradios/francemusique_la_contemporaine",
	},
	item{
		title:       "FIP Groove",
		...
		metadataUrl: "https://www.radiofrance.fr/fip/api/live/webradios/fip_groove",
	},
	item{
		title:       "FIP Rock",
		...
		metadataUrl: "https://www.radiofrance.fr/fip/api/live/webradios/fip_rock",
	},
	item{
		title:       "FIP Metal",
		...
		metadataUrl: "https://www.radiofrance.fr/fip/api/live/webradios/fip_metal",
	},
	item{
		title:       "FIP Hip-Hop",
		...
		metadataUrl: "https://www.radiofrance.fr/fip/api/live/webradios/fip_hiphop",
	},
	item{
		title:       "FIP Pop",
		...
		metadataUrl: "https://www.radiofrance.fr/fip/api/live/webradios/fip_pop",
	},
	item{
		title:       "FIP Electro",
		...
		metadataUrl: "https://www.radiofrance.fr/fip/api/live/webradios/fip_electro",
	},
	item{
		title:       "FIP Monde",
		...
		metadataUrl: "https://www.radiofrance.fr/fip/api/live/webradios/fip_world",
	},
	item{
		title:       "FIP Reggae",
		...
		metadataUrl: "https://www.radiofrance.fr/fip/api/live/webradios/fip_reggae",
	},
	item{
	...
	item{
		...
		metadataUrl: "https://www.radiofrance.fr/francemusique/francemusique/api/webradio",
	},
	item{
		...
		metadataUrl: "https://www.radiofrance.fr/francemusique/radio-classique-easy/api/webradio",
	},
	item{
		title:       "Opéra",
		...
		metadataUrl: "https://www.radiofrance.fr/francemusique/radio-opera/api/webradio",
	},
	item{
		title:       "La Baroque",
		...
		metadataUrl: "https://www.radiofrance.fr/francemusique/radio-baroque/api/webradio",
	},
	item{
		...
		metadataUrl: "https://www.radiofrance.fr/francemusique/radio-classique-plus/api/webradio",
	},
	item{
		...
		metadataUrl: "https://www.radiofrance.fr/francemusique/radio-concerts/api/webradio",
	},
	item{
		title:       "La Jazz",
		...
		metadataUrl: "https://www.radiofrance.fr/francemusique/radio-jazz/api/webradio",
	},
	item{
	...
	item{
		...
		metadataUrl: "https://www.radiofrance.fr/francemusique/radio-musiques-films/api/webradio",
	},
}
